...
- Milestone 3: multiplayer movement. Added a Join screen (name and color), friends' browsers find each other with Trystero, everyone sees each other walk around, sidebar shows who's in which room. Waiting on your test.

## Next
- Confirm Milestone 3 works: open the site in two browser windows and check they see each other move.
